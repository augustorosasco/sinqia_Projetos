            ...
            <div class="col-md-5">
                ...
                <div class="form-group">
                    ...
                    <asp:RequiredFieldValidator ID="documentoRequiredFieldValidator" runat="server"
                        ControlToValidate="documentoTextBox" ErrorMessage="O Documento deve ser informado" Display="Dynamic">
                ...
                <div class="form-group">
                    ...
                    <asp:RequiredFieldValidator ID="nomeRequiredFieldValidator" runat="server" ControlToValidate="nomeTextBox" ErrorMessage="O nome deve ser informado" Display="Dynamic"></asp:RequiredFieldValidator>
                </div>
                ...
                <div class="form-group">
                    ...
                    <asp:RequiredFieldValidator ID="telefoneRequiredFieldValidator" runat="server" ControlToValidate="telefoneTextBox" ErrorMessage="O telefone deve ser informado" Display="Dynamic"></asp:RequiredFieldValidator>
                </div>

                <div class="form-group">
                    <asp:Label ID="emailLabel" runat="server" Text="E-mail: "></asp:Label>
                    <asp:TextBox ID="emailTextBox" CssClass="form-control" runat="server"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="emailRequiredFieldValidator" runat="server" ControlToValidate="emailTextBox" ErrorMessage="O E-mail deve ser informado" Display="Dynamic"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="emailRegularExpressionValidator" ControlToValidate="emailTextBox" runat="server" ErrorMessage="Email inválido" Display="Dynamic" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                </div>

                <div class="form-group">
                    <asp:Button ID="enviarButton" CssClass="btn btn-primary" runat="server" Text="Incluir Cliente" OnClick="enviarButton_Click"></asp:Button>
                </div>                  
