...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="calcularButton" runat="server" Text="Calcular Soma" OnClick="calcularButton_Click" />
            <br/>
            <asp:Button ID="nomesButton" runat="server" Text="Listar Nomes" OnClick="nomesButton_Click" />
            <br/>
